...
function SecurityForm({ initial }: { initial: SecuritySettings }) {
  ...
  return <div className="h-full rounded-2xl border border-border bg-surface p-4">
    ...
    <div className="mt-4 divide-y divide-border overflow-hidden rounded-xl border border-border bg-surface-2">
    ...
    <fieldset disabled={saving} className="space-y-2 p-4">
