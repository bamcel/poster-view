...
function SecurityForm({ initial }: { initial: SecuritySettings }) {
  ...
  return <div className="h-full rounded-2xl border border-border bg-surface p-4">
    ...
    <div className="mt-4 grid overflow-hidden rounded-xl border border-border bg-surface-2 xl:grid-cols-2">
    <fieldset className="space-y-2 border-b border-border p-4">
    ...
    <fieldset disabled={saving} className="space-y-2 border-b border-border p-4 xl:border-l">
    ...
    <fieldset disabled={saving} className="space-y-2 border-b border-border p-4 xl:border-b-0">
    ...
    <fieldset disabled={saving} className="space-y-2 p-4 xl:border-l xl:border-border">
